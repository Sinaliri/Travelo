...
const Footer = () => {
  const items = [
    { text: "Profile", link_url: "./profile" },
    { text: "Creat a trip!", link_url: "./create-trip" },
    { text: "Find your favorite ones!", link_url: "./people" },
    { text: "Settings", link_url: "./profile/settings" },
   
  ];
  const socialMedia = [instagram, facebook, whatsapp];
  return (
    <div
      className="Footer p-6 flex flex-row"
    ...
    >
      ...
      <div className="Footer_QuickLinks flex-1">
        ...
        <div className="text-lg flex flex-column" style={{ gap: "10px" }}>
          {items.map((item) => {
            return <div key={item.index}><Link href={item.link_url}>{item.text}</Link></div>;
          })}
        </div>
      </div>
      ...
      <div className="Footer_additionalLinks flex-1">
        ...
        <div className="flex">
          <h4 className="text-xs font-normal" style={{ color: "#515151" }}>
            {" "}
            2023{" "}
          </h4>
        ...
        <h4 className="text-xs font-normal mt-1" style={{ color: "#515151" }}>
          {" "}
          All Rights Reserved
        </h4>
        ...
        <div>
          {socialMedia.map((item) => {
            return <Image key={item.index} src={item} alt="socialmedia" width={40} />;
          })}
        </div>
